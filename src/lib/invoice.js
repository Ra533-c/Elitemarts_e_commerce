...
// Last updated: 2026-01-07 - Force rebuild to fix EROFS error

export async function generateInvoice(order) {
    // NEVER write to filesystem on Vercel - it will cause EROFS errors
    ...
    console.log('Invoice generation skipped for order:', order.orderId, '- Vercel filesystem is read-only');
    return null;
}
